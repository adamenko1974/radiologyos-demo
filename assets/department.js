...
const DEFAULT_STAFFLIST = [
  { name: '', role: 'Завідувач відділення, лікар-рентгенолог', schedule: 'Пн–Пт 8:00–15:00' },
  { name: '', role: 'Лікар-рентгенолог', schedule: 'Пн–Сб 9:00–17:00' },
  { name: '', role: 'Рентгенлаборант', schedule: 'Пн–Сб 8:00–17:00' }
];
